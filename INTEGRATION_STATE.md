...
Core finally gave Tofu enough person-level material to stop letting screenshot behavior carry the entire biography. Tofu directly says new hires mistake her for a manager because she picks up departmental slack, calls herself `a squishy person irl`, and says she projects a scary image so she does not get hurt. Her later retail answer turns that defense style into behavior: rude customers can receive theatrical delay, fake equipment problems, unnecessary trips, matched energy, or simply lose access to Tofu if they whistle at her like a dog. The usable synthesis is accidental authority + habitual overfunctioning + deliberate menace as boundary armor, not a management credential or violence claim.

The same suffix makes Tofu↔Cookie clearly cumulative rather than three isolated jokes. Tofu repeatedly selects Cookie as the person to fight, throw at hypothetical danger, rescue from bad weather and then fight anyway, or compliment before immediately making the compliment meaner. Cookie's `:Fat_Wheeze:` participation keeps the register reciprocal. WIKI files this as comfortable antagonistic affection / teasing, never literal hostility, violence, romance, sex, kinship, or closeness rank.
...
The suffix `56acd6cf -> 315a33bf` was successfully reviewed and intentionally produced no reader mutation.

Queen Shimoko's compact gross/absurd-humor reactions, Aesh's direct `WONHO SUPREMACY`, Gabu's immediate Corpse Husband reaction plus Anthos's `you have summoned gabu`, and Ren's probable Pride/corpse callback object are all valid local character/taste reads. They are either too thin, already adequately represented by richer public owners, or still carry unresolved media/source boundaries. None justified a duplicate one-line public fragment this pass.
