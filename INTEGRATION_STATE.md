...
**WIKI reader-facing changes:** new `src/data/integrator-cast-run1374-wall-ghostt.ts`, loaded through `src/data/all-content.ts`. Final canonical reader commit: **`800e56531fff090ad4ce6c0b0cbdfc5378296421`**.

Verification for that reader commit passed:
