...
The controlling MAIN ledger now marks Daycare consumed through **`b739ee86733079618ed5c73b90f9fe58f31afa56`** and returns it to `pending_publication` for MAIN resynthesis debt. A concurrent Run 712 opening census has since found Wall advanced separately from `a8f619040fc6c64072011d637dfc57317d90772c` to `65292b680dee234e1ffca8b57574e871bae6f264`; that Wall delta is Run 712's unread frontier and was not silently consumed by Run 711.
