...
- Wall current/consumed at `fc744788390409f93bd0e9808dba4e028878cc8b`.
- Whiskey current/consumed at `c5c6080392fc95736629d1054b0163bd8ccf3757`.
...
Wall q9/native recovery remains open / retrieval-limited. Akane's direct H2 Whiskey-authored voice remains source-limited; Lobby / Photo Submissions prose is not relabeled as Whiskey. The Akane attachment pixels remain unrecovered, so media attribution stays bounded. Gabby's later photo follow-through remains not recovered from the currently indexed Photo Submissions copies after stable-ID, account, and display-name probes; this remains a source-local negative, not `Gabby never submitted`, and those same probes stay DNR until the source/index changes. Core's two Gilli-like stable accounts remain separate absent an explicit bridge.
