...
The Run-66 material is strong but not a new public delta. Kiro's Send-button friction → low-friction Mugen register, Gabu's shy/language-conscious entry → front-door wayfinding, Ansun's Wall shame-to-fame self-mythology plus Anayss shorthand, and Anayss's recipient-before-helper onboarding arc plus Snow/Ansun familiarity are already represented on current MAIN person-first pages. WIKI already has the complementary role/reference ownership and does not need duplicate Episodes or copied biography paragraphs.
...
- `archive-miner/all-characters-hr-20260828` — consumed through `6c3c2ae015131cd01e3d226672075e9b5fdb4b19` after successful duplicate/corroboration review.
