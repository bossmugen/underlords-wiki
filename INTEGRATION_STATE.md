...
This close is review-current across all active miner refs. The Wall hold is publication verification only; future cycles must not reread the same reviewed delta.
