...
const additions: Character[] = [
  ...
  },
  {
    ...
    role: "Staff",
    era: "2020–2023+",
    logline: "Low-ceremony archive cast with a wonderfully selective sense of drama: real school fights are `weirdos` and not worth following into the hallway; fictional-emperor rage merits `Hug me ... before I kill somebody`. Around people, warmth tends to arrive as shorthand, roast-as-care, and replies that assume the missing context is somebody else's problem.",
    tags: ["Staff", "UL member", "Whiskey", "Wall", "Low-context shorthand"],
    relationships: [
      { name: "Gilli", note: "Eos later names Gilli as a reason for joining UL; that does not resolve invitation mechanics.", href: "/characters/gilli" },
      { name: "Milo", note: "Care-through-roast: Eos notices Milo cutting back and approves it as `You finally limiting yourself, u whale ... good`.", href: "/characters/milo" },
      { name: "Panda", note: "Marian/Panda is a recurring Wall and bot-game counterpart; playful commands and prosecution banter stay social/game language rather than literal relationship classification.", href: "/characters/panda" },
    ],
    quotes: [
      "Whats so interesting about pull-hair fights that gets the whole class to leave the room to watch? Idek",
      "Im just stupid in english",
      "You finally limiting yourself, u whale ... good",
