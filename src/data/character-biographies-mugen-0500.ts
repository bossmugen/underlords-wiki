...
const mugenCommunicationBandwidth = [
  ...
  "She does the same thing with ordinary-life context. In August 2021 Mugen dismisses the local summer with `summer ain't shit here compared to Cambodia`; by October she is reporting `its 4C rn`, immediately translating it as `like 39f for u Americans`, then anticipating `It’ll be our first snow fall I think this weekend`. The unit switch is tiny but very Mugs: she can stay inside her own frame and still translate just enough to keep the room with her. Even weather becomes a little bridge — her baseline, their units, same conversation."
];
