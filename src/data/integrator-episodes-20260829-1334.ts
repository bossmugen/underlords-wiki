...
export const lateAugustIntegratedEpisodes: Episode[] = [
  {
    ...
    kind: "Wall of Shame defendant style / recurring procedural disbelief instead of remorse",
    logline: "Across repeated Wall appearances, Tae keeps responding as though the evidence archive has made an administrative error: `Why im on here- I didn’t do anything shameful`, `AGAIN`, `Why im I here`, `What is this`, `WHY WOULD YOU`, `Rv why`, and later simply `WHY`. The funniest version lands when Tae asks Ren `But why rv, why` and Ren answers less than a second later with three silent sip emotes. This is more specific than calling Tae chaotic. The receipts keep arriving; Tae keeps requesting procedural review. Gilli is POSTED BY for the two June 2 screenshots, but their pixels remain uninspected and POSTED BY does not become MADE BY, CAPTURED BY, or FEATURING. The recurrence is the character beat, not a claim that Tae objected to every Wall post she ever appeared in.",
    cast: ["Tae", "Ren", "Gilli", "Mugen"]
  },
  {
    id: "hamittey-forgot-this-vacation-return",
    title: "Forgot I Had This / Welcome Back From Vacation",
    season: "2021",
    date: "August 3, 2021",
  ...
  },
  {
    ...
    season: "2020",
    date: "October 1–19, 2020",
    kind: "Dragon Raja dungeon luck / reciprocal account-running / the unfun half of being team lead",
    logline: "Danny tells Mugen that `3 out of 4 orange dracs` have now turned up while he was on other people's accounts, calls the pattern `Cursed.`, then immediately develops the haunting into a business model: `Maybe I should start charging daily packs to do peoples dungeons. Embrace the curse.` Eleven days later the traffic goes the other direction explicitly: `carl is running my account tomorrow, hes on donation strike.` At least one account-running arrangement in Danny's orbit was therefore reciprocal rather than merely a hypothetical dungeon joke. His workplace thread also gets an independent second receipt on October 19: an equipment delivery has not arrived, so Danny has `13 people to keep busy with very little work available`. The archive accidentally supplies both halves of his earlier `im team leader` swagger — first `Ill do what I want`, then the very unglamorous reality of finding work for thirteen people when the equipment does not show up. Exact employer, industry, job title, direct-report structure, Carl's relationship to Danny, and the Dragon Raja screenshot's visual provenance remain unresolved.",
    cast: ["Danny", "Mugen"]
  },
  {
