...
roles:
  - "Game Officer"
summary: "Ame is a Game Officer whose clean surviving character file is less about rank than about the front door repeatedly learning how to talk to the person standing in it: Ame says he understands little English, Ren switches the onboarding exchange into Spanish, and later returns are recognized as returns rather than rewritten as first arrivals."
summaryEvidence: "archive-confirmed"
publication: "public"
claims:
  - text: "The recovered Lobby export resolves Ame / Amexistir to stable Discord account ID 357923467838095361, username `amexistir`, nickname `Amexistir`."
    evidence: "archive-confirmed"
    date: "2022-11-23 – 2023-11-17"
  - text: "On November 23, 2022, Ame writes in Spanish that he understands little English and that his in-game name is the same as the name he is using there."
    evidence: "archive-confirmed"
    date: "2022-11-23"
  ...
  - text: "On November 17, 2023, MEE6 again produces a generic welcome for the same account, but Anayss follows with `Hola Ame! Bienvenido de vuelta!`, explicitly framing the event as a return."
    evidence: "archive-confirmed"
    date: "2023-11-17"
  - text: "Current roster canon files Ame under Game Officers. The surviving Lobby scenes do not independently date when that appointment began."
    evidence: "canon-lock"
antiFanon:
  - "Do not infer Ame's nationality from Spanish-language messages."
