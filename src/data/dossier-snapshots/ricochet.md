...
publication: "public"
claims:
  - text: "The stable Ricochet account 459696170759880745, username `dragonrichard`, is already posting media in Whiskey by May 16, 2020."
    evidence: "archive-confirmed"
    date: "2020-05-16"
    note: "This is earliest surfaced Whiskey presence in the current handoff, not a proven Discord join date, UL admission date, or recruitment date. The attached MOV remains uninspected."
  - text: "On September 16, 2020, Ricochet wrote `my family getting this pupper soon` while posting an image."
    evidence: "archive-confirmed"
    date: "2020-09-16"
    note: "The image remains uninspected. Do not infer the animal's breed, name, sex, age, exact owner, or whether the plan ultimately happened."
  - text: "On January 12, 2021, Ricochet used Dragon Raja as the room's comparison unit for another game: `Y’all think playing raja was bad look at this guy in my tank game with almost 100k battles`."
    evidence: "archive-confirmed"
    date: "2021-01-12"
    note: "The attached screenshot remains uninspected and is not being attributed as Ricochet's own account."
  - text: "On February 14, 2021, Ricochet wrote `Way to freaking cold for south texas`."
    evidence: "archive-confirmed"
    date: "2021-02-14"
    note: "This supports South Texas context for that scene only, not a complete residence history."
  - text: "On April 10, 2021, Ricochet said a linked video made him want to try something `if i ever get married now`."
    evidence: "archive-confirmed"
    date: "2021-04-10"
    note: "The video contents are not interpreted here. The line is a hypothetical future-marriage thought, not evidence of current relationship status, engagement, or wedding plans."
  - text: "On May 17, 2021, Ricochet directly asked Gilli when an unresolved game was coming out."
    evidence: "archive-confirmed"
    date: "2021-05-17"
    note: "The game title is unresolved; the safe character evidence is the direct Gilli address."
  - text: "On June 18, 2021, Panda / Marian Kage wrote that Ricochet `got me my Cheesecake Factory`, then immediately added `(but no cheesecake)`."
    evidence: "archive-confirmed"
    date: "2021-06-18"
...
April 10, a video link makes Ricochet say:
