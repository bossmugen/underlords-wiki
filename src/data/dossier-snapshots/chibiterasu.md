...
roles:
  - "Game Officer"
  - "Parterre Gardener"
summary: "Chibiterasu / Chuutan / Chubi is a Game Officer and Parterre Gardener whose current public file stays intentionally modest: a clean 2022 self-identification, a 2024 return through the same Discord account using the Chuu~tan name, and a roster-level alias bridge strong enough to keep all of those names on one character rather than multiplying the cast."
...
claims:
  ...
  - text: "Immediately after the 2024 `Chuu~tan` check-in, Sye replies `chu chu`, giving a small human recognition beat around the repeated Lobby procedure."
    evidence: "archive-confirmed"
    date: "2024-05-13"
  - text: "Current corrected roster canon resolves Chibiterasu, Chuutan, Chubi, Chuubi, and Chibi to one character file."
    evidence: "canon-lock"
  - text: "Current corrected roster canon files Chibiterasu under Game Officers and carries Parterre Gardener as a specialist appointment. The Lobby receipts do not date either appointment."
    evidence: "canon-lock"
antiFanon:
  ...
  - "Export-time role arrays do not date Game Officer or Gardener appointment chronology."
relatedPeople:
  - "sye"
tags:
  - "game-officer"
