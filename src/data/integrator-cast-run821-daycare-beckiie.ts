...
allCharacters[beckiieIndex] = {
  ...
  logline: appendOnce(
    beckiie.logline,
    "Off the Wall, the same comic volume has a practical spine: Beckiie can turn `wtf` into checking who else got disconnected and then `now imma email them and have them give me my dang mount` without missing a beat.",
