...
export const characters: Character[] = [
  ...
  { id:"suzimasu", name:"Suzi", aliases:["Suzimasu","Mob","BAPE","Sushi","mob_bape","Mob | BAPE"], billing:"legacy", role:"Founder · retired Officer · Consigliere", era:"2020–", logline:"Founder and retired Consigliere whose scary first impression did not survive ordinary exposure: brisket, forgotten bathroom drinks, alien conversations, voluntary Wall self-incrimination, and a habit of reassuring Ren without leaving the joke.", tags:["Founder","Retired Officer","Consigliere","Streetwear","BAPE","Wall","Smoked meat","Petty Crimes"], relationships:[{name:"Ren",note:"Ren once `sensed danger`, later greeted the returning Mob with `Welcome home~`, and on the Wall gets `Aww it’s okay` / `I still wuv you` when her self-roast turns tender. The intimidating first impression and the easy reassurance belong to the same long-running peer rhythm.",href:"/characters/ren"},{name:"Mugen",note:"Mugen can greet a resurfacing Suzi by name and later summon Mob with `Bbq bb`; the shorthand works because smoked meat is already ordinary Suzi territory.",href:"/characters/mugen"},{name:"Tofu",note:"Suzi will apparently try mustard on watermelon and still refuse to dignify Tofu calling watermelon itself gross. Experimental fruit decisions do not cancel fruit loyalty.",href:"/characters/tofu"}], quotes:["Trying to win the wall of shame awards","Aww it’s okay @RΣN","I still wuv you","SMOKED MEAT ANYKIND GIBBBB","I can explainnnnnnn"] },
  ...
  { id:"eos", name:"Eos", billing:"legacy", role:"Archive-era Daycare / Wall cast", era:"2021–2023+", logline:"Low-word, high-consequence regular: affection, embarrassment, counter-prosecution, and spare receipts all arrive in compact sentences, to the point that other people start summoning Eos when a Panda needs to be punished.", tags:["Archive cast","Daycare","Wall","2021","Petty Crimes"], relationships:[{name:"Marian Kage",note:"Their visible closeness can hold affection, mutual embarrassment, retaliation, and joking `divorced` consequences without the relationship leaving the bit."}], quotes:["this is war","Debating on sending more","yep.... @Marian Kage cmere"] }
];
...
export const episodes: Episode[] = [
  { id:"founding-underlords", title:"The Founding", season:"2020", date:"March 2020", kind:"Origin", logline:"Mugen leaves Altissa to start Underlords; Ritha, WolfPhenix, Suzi, and HyaLuna come with her, forming the five-person founding circle.", cast:["Mugen","Ritha","WolfPhenix","Suzi","HyaLuna"] },
...
export const relationshipGroups = [
  { title:"Founding Circle", people:["Mugen","Ritha","WolfPhenix","Suzi","HyaLuna"], note:"Mugen founded UL; the other four came with her from Altissa." },
