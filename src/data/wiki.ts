...
export const characters: Character[] = [
  ...
  { id:"mia", name:"Mia", aliases:["Mimi","Miaka","Opalite Honey"], billing:"main", role:"Pit Boss · UL Interrogator · Game Officer · Platelet", era:"2021–present", logline:"Interrogator, Officer, Platelet, and recurring proof that UL job titles refuse to stay in one category.", tags:["Officer","Interrogator","Platelet"] },
...
export const seasons: Season[] = [
  ...
  { year:"2025", title:"Season Six — Decommissioning", subtitle:"the guild gets an ending; the cast does not", summary:"The in-game Dragon Raja club is wound down, old rooms thin at different speeds, and UL remains portable as a social identity across games and off-channel relationships." },
...
export const locations = [
  ...
  { id:"the-wall", name:"The Wall", type:"Screenshot jail", logline:"Where the present gets preserved long enough to become archaeology." },
