export const integratedGags = [
  ...
  },
  {
    ...
    logline:
      "The Wall never managed to choose between punishment and applause. Snow was already promising an Ansun post was ‘DEFINITELY going on the wall’ in August 2020; by March 2021 Ren was selling Eos on ‘fuck the shame!! You will love the fame’ and Saber had compressed the whole system into ‘SHAME THE FAME.’ Han eventually asked the taxonomy question outright when Mugs threatened his ‘wall/shame’: ‘Is it fame or shame lol.’ Mugs ruled: ‘Both.’ By 2022 Mugs was calling the Wall ‘the peoples history,’ while members still asked ‘fame or shame?’ before volunteering fresh evidence. Public humiliation, recognition, and communal memory became the same scrapbook because these people were apparently constitutionally incapable of maintaining separate folders.",
  },
  {
