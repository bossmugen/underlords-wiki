...
const kuki: ExtendedCharacter = {
  ...
  era: "2020+",
  logline:
    "Kuki is equal parts quick room-comic and recurring defendant: he can grab a pun while it is still warm, answer somebody else's fake exit with `u cant leave`, then spend the next filing insisting `its not how it looks like`. Louvre adds the ordinary maker side—claiming his own art and comparing wrist trouble with other artists—while Wall makes the social mechanism obvious: embarrassment does not remove him from the room; it gives him another way to participate.",
  tags: [
    "Archive cast",
    "Staff",
    "Louvre",
  ...
  claims: [
    ...
    "By October 2021 Kuki can also be the Wall's mock-defendant, including the compact `its not how it looks like` → `i swear` defense. Together with his punchline/callback behavior, the recurring contradiction is useful: he can generate the bit or become its target without disengaging from the room.",
  ],
  antiFanon: [
