...
allCharacters.push({
  ...
  relationships: [
    ...
    { name: "Marian", note: "Anayss's exact-parent reply to Marian's Rummy roast is a soft check rather than a fight: `Why are you so rude to rummy though uwu`. It shows she can push back on a roast while keeping the room's playful register intact." },
