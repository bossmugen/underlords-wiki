...
const tonySeed: ExtendedCharacter = {
  ...
  era: "2022+",
  description:
    "Tony's Wall panic is loud without being socially closed. When a receipt lands he can go straight to `NO`, `STOP`, and `DONT SHOW THEM`; with people he is comfortable enough to joke with, the protest turns porous almost immediately. Rummy can pat him mid-spiral, get cat-emote shorthand back, sabotage the reassurance with `....maybe-`, and still receive a blush. What starts as rapid-fire defendant energy also turns into participation: Tony remembers old bits well enough to revive them, can carry a receipt himself, and eventually self-prosecutes before anybody else has to. The embarrassment never really leaves. He just gets increasingly good at making himself part of the joke anyway.",
  logline:
    "Caps-lock Wall defendant, callback-literate co-author, voluntary self-roaster, and surprisingly tease-safe good sport: Tony objects loudly, remembers the room's old crimes, carries exhibits, accepts the emotional-support pats, and somehow remains in court.",
  tags: [
    "Archive cast",
    "Wall",
    "Caught defendant",
  ...
  claims: [
    ...
    "By April Tony is doing more than surviving other people's filings. He remembers the room's absurd `losing the bodies` bit well enough to bring it back the next day with `You gotta be careful with bodies can’t just misplace them like that`, later TRUE-REPLIES `He said this with goats too`, and then posts a Wall attachment of his own eighteen seconds later. In the surviving Wall sample, the loudly exposed newcomer has become a callback-literate participant who can help carry the joke and the receipts.",
    ...
    "Petty Crimes: caps-lock anti-publication campaigns, genuine horror that soggy bacon exists, remembering the goat/body-running-gag lore, conceding that somebody looks pretty while still prosecuting the haircut, and crowning himself typo CEO immediately before failing at a one-letter word.",
    "The relevant media objects `3.PNG`, `g.PNG`, `IMG_9263.png`, and Tony's April 27 attachment were not visually inspected and remain POSTED-BY anchors only.",
  ],
  antiFanon: [
    ...
    "The `losing the bodies` callback is a room joke. Do not turn it into literal violence, disposal, crime, or real-world conduct.",
    "Tony's haircut comment is a social reaction around an uninspected image; do not invent the depicted person's identity, appearance, or hairstyle beyond what Tony actually says.",
    ...
    "`3.PNG`, `g.PNG`, `IMG_9263.png`, and Tony's April 27 attachment are POSTED BY their uploaders only. MADE BY, CAPTURED BY, and FEATURING remain unresolved.",
