...
Added a structured Cast owner rather than inventing a thin MAIN biography. The dossier synthesizes a stable maker/mechanical taste cluster — cars, planes, engineering/engines, Lego — with lived troubleshooting behavior across years. The character read is methodical process with unserious presentation: test, explain, discover the bad assumption, say `ignore me` / `fuck me`, test again, and eventually celebrate that everything works. Later bot amnesia (`i forgot how to uses this bot xD`) does not cancel the competence; it clarifies the more useful trait, which is willingness to admit the gap, retrieve help and keep going.

Snow is an explicit practical help/co-debugging relationship. Drink water reminder is reciprocal technical problem-solving across years rather than a fixed expert/student hierarchy. Miner shorthand was not promoted into a public alias. Exact-game/addressee ambiguity remains backstage.

### BishopThaGuru

Deepened the existing canonical Bishop owner with the recurring Bishop↔Tofu Wall lane. Tofu's repeated filings/callouts illuminate Bishop's existing defendant contradiction: he acts hunted by scrutiny — feds, secret files, warnings — and then grabs the attention back through faux injury, attraction reframing, innuendo or self-filing theatrics. Scrutiny functions less like a deterrent and more like stage lighting.
...
Exact reader commit containing both accepted public integrations: `c3e2bbc1c8233250d8a1d2b5cc1134705194ceff`.

- `Build Underlords Wiki` run `34657858775`: success.
- `Build and Deploy Underlords Wiki Preview` run `34657858770`: success.
  - build/artifact `103454035931`: success
